...
public class TreasureRoom extends Room {
    public TreasureRoom() {
        super("empty");
        collectables.add(PotionManager.create("health", "common", 200,
                200, Player.POTION_DURATION));
        collectables.add(PotionManager.create("attack", "common", 400,
                400, Player.POTION_DURATION));
